...
**Last synced:** 2026-09-16 (auth.md added; `GET /dashboard/summary` discovered in openapi.json, undocumented in any `.md`; factory.md/depot.md still dated 2026-09-12)
