...
/** Reuses product/quantity ids/names from src/mock/catalog.mock.ts. At least one of each status. */
export const mockSupplyRecords: SupplyRecord[] = [
  { id: 1, productId: 4, quantityId: 5, amount: 80, productName: 'Pepsi 500ml', quantityValue: 'Crate-24', status: 'received', rejectionReason: null, createdDate: '2026-09-02T09:15:00Z' },
  { id: 2, productId: 1, quantityId: 2, amount: 50, productName: 'Pepsi 1L', quantityValue: '1L', status: 'pending', rejectionReason: null, createdDate: '2026-09-04T08:20:00Z' },
  { id: 3, productId: 2, quantityId: 1, amount: 40, productName: 'Mirinda 500ml', quantityValue: '500ml', status: 'rejected', rejectionReason: 'Quantity mismatch: expected 40, received 35', createdDate: '2026-09-05T09:30:00Z' },
  { id: 4, productId: 3, quantityId: 1, amount: 60, productName: '7up 500ml', quantityValue: '500ml', status: 'pending', rejectionReason: null, createdDate: '2026-09-06T08:00:00Z' },
  { id: 5, productId: 5, quantityId: 2, amount: 30, productName: 'Mountain Dew 1L', quantityValue: '1L', status: 'received', rejectionReason: null, createdDate: '2026-09-06T10:30:00Z' },
  { id: 6, productId: 4, quantityId: 5, amount: 100, productName: 'Pepsi 500ml', quantityValue: 'Crate-24', status: 'pending', rejectionReason: null, createdDate: '2026-09-07T09:00:00Z' },
];
